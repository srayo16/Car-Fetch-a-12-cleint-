...
const BusinessSummary = () => {
    ...
    return (
        <div className='container mx-auto mt-28'>
            ...
            <div className='mx-10'>
                <div className="stats  stats-vertical lg:stats-horizontal container mx-auto my-14 shadow">
                    ...
                    <div className="stat  place-items-center">
                        ...
                        <div className="stat-title text-8xl text-primary"><BsFlagFill></BsFlagFill></div>
                        <div className="stat-value">80+</div>
                        <div className="stat-desc text-2xl text-primary font-semibold">Countries</div>
                    </div>
                    ...
                    <div className="stat  place-items-center">
                        ...
                        <div className="stat-title text-8xl text-primary"><IoIosPeople></IoIosPeople> </div>
                        <div className="stat-value">700+</div>
                        <div className="stat-desc text-2xl text-primary font-semibold">Happy Clients</div>
                    </div>
                    ...
                    <div className="stat  place-items-center">
                        ...
                        <div className="stat-title text-8xl text-primary"><FaLaptopCode></FaLaptopCode></div>
                        <div className="stat-value">800+</div>
                        <div className="stat-desc text-2xl text-primary font-semibold">Projects</div>
                    </div>
                    ...
                    <div className="stat  place-items-center">
                        ...
                        <div className="stat-title text-8xl text-primary"><AiTwotoneLike></AiTwotoneLike></div>
                        <div className="stat-value">500+</div>
                        <div className="stat-desc text-2xl text-primary font-semibold">Feedbacks</div>
                    </div>
                </div>
            </div>
