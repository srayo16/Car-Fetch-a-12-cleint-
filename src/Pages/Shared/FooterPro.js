        ...
        <div className='bg-primary'>
            <footer className="footer footer-center lg:footer container mx-auto p-10 bg-primary text-primary-content text-center lg:pl-48 ">
                <div>
                    ...
                    <Link to='/null' className="link link-hover">Design</Link>
                    <Link to='/none' className="link link-hover">Marketing</Link>
                    <Link to='/404' className="link link-hover">Advertisement</Link>
                </div>
                <div>
                    <span className="footer-title">Company</span>
                    <Link to='/blank' className="link link-hover">About us</Link>
                    <Link to='/notbuild' className="link link-hover">Contact</Link>
                    <Link to='/no' className="link link-hover">Jobs</Link>
                    <Link to='/await' className="link link-hover">Press kit</Link>
                </div>
                <div>
            ...
            <footer className="footer footer-center p-4 bg-primary text-primary-content">
                <div>
                    <p>Copyright © {year} - All right reserved by Car Fetch Ltd</p>
                </div>
            </footer>
        </div>
